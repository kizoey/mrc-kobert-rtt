...
class Trainer:
    ...
    Args:
        ...
        train_dataset (:obj:`torch.file_utils.data.dataset.Dataset` or :obj:`torch.file_utils.data.dataset.IterableDataset`, `optional`):
            The dataset to use for training. If it is an :obj:`datasets.Dataset`, columns not accepted by the
            ``model.forward()`` method are automatically removed.

            Note that if it's a :obj:`torch.file_utils.data.dataset.IterableDataset` with some randomization and you are
        ...
        eval_dataset (:obj:`torch.file_utils.data.dataset.Dataset`, `optional`):
    ...
    def get_train_dataloader(self) -> DataLoader:
        """
        Returns the training :class:`~torch.file_utils.data.DataLoader`.
    ...
    def get_eval_dataloader(self, eval_dataset: Optional[Dataset] = None) -> DataLoader:
        """
        Returns the evaluation :class:`~torch.file_utils.data.DataLoader`.
    ...
    def get_test_dataloader(self, test_dataset: Dataset) -> DataLoader:
        """
        Returns the test :class:`~torch.file_utils.data.DataLoader`.

        Subclass and override this method if you want to inject some custom behavior.

        Args:
            test_dataset (:obj:`torch.file_utils.data.dataset.Dataset`, `optional`):
    ...
    def num_examples(self, dataloader: DataLoader) -> int:
        """
        Helper to get number of samples in a :class:`~torch.file_utils.data.DataLoader` by accessing its dataset.

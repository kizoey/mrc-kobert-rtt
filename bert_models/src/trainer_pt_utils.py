...
class DistributedSamplerWithLoop(DistributedSampler):
    """
    Like a :obj:torch.file_utils.data.distributed.DistributedSampler` but loops at the end back to the beginning of the
    shuffled samples to make each process have a round multiple of batch_size samples.

    Args:
        dataset (:obj:`torch.file_utils.data.Dataset`):
...
class IterableDatasetShard(IterableDataset):
    ...
    Args:
        dataset (:obj:`torch.file_utils.data.dataset.IterableDataset`):

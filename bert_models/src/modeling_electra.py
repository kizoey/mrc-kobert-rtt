...
class ElectraForQuestionAnswering(ElectraPreTrainedModel):
    ...
    def forward(self, input_ids=None,
        ...
        if cls_labels is not None:
            ...
            pooled_output = discriminator_hidden_states[1]  # bsz x 1 x 768
    ...
    #         else:
    #             ner_loss = loss_fct(ner_logits.view(-1, self.num_ner_labels), label_ids.view(-1))
    #     outputs = (start_logits, end_logits,) + discriminator_hidden_states[2:]
    #
    #     total_loss = None
    #     if start_positions is not None and end_positions is not None:
    #         # If we are on multi-GPU, split add a dimension
    ...
    #     return start_loss, end_loss, ner_loss, outputs
    #     # if not return_dict:
    #     #     output = (
    #     #         start_logits,
    #     #         end_logits,

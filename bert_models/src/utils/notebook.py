...
class NotebookProgressBar:
    ...
    Args:
        ...
        leave (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            :meth:`~transformers.file_utils.notebook.NotebookProgressBar.close` method to make the bar disappear.
        parent (:class:`~transformers.notebook.NotebookTrainingTracker`, `optional`):
            A parent object (like :class:`~transformers.file_utils.notebook.NotebookTrainingTracker`) that spawns progress
...
class NotebookTrainingTracker(NotebookProgressBar):
    ...
    Args:
        ...
        column_names (:obj:`List[str]`, `optional`):
            ...
            :meth:`~transformers.file_utils.notebook.NotebookTrainingTracker.write_line` if not set).
    """

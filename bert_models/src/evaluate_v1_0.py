...
def eval_during_train(args):
    ...
    # prediction_file = os.path.join(args.output_dir, 'predictions_{}.json'.format(args.prefix))
    prediction_file = os.path.join(args.output_dir, 'predictions_.json')
    # prediction_file = '/home/mnt/wjddn803/mrc/koelectra-base-v3-korquad-ckpt/predictions_.json'
    output_nbest_file = os.path.join(args.output_dir, "nbest_predictions_.json")
    # output_nbest_file = '/home/mnt/wjddn803/mrc/koelectra-base-v3-korquad-ckpt/nbest_predictions_.json'
